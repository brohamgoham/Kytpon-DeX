          ...
          <div className={ classes.disclaimer } style={{ marginTop: '25px', maxWidth: '500px' }}>
            <Grid container spacing={1}>
              ...
              <Grid item xs>
                ...
                Krypton Finance also offers DeFi Insurance
                </Typography>
              </Grid>
            </Grid>
            <Typography variant="body1">
              To find out more about how claims are assessed and paid out, go to <a href="https://docs.coverprotocol.com/product/claims-guidelines" rel="noopener noreferrer" target="_blank">Krypton Finance cover protocol</a>
            </Typography>
          </div>
        </div>
        { loading && <Loader /> }

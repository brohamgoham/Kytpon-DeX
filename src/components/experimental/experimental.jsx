    ...
    return(
      <div className={ classes.disaclaimer } style={{ marginTop: '25px', maxWidth: '500px' }}>
        ...
        <Typography variant="body1">
          Krypton DeX DeFi and Crypto insurance. Fortress of Solitude= contributors are rewarded with <b>0.5%</b> of yield generated by the Fortress. <a href="https://krypton.io" rel="noopener noreferrer" target="_blank">Learn more &rarr;</a>
        </Typography>
      </div>
    )
  }

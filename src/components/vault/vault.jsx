...
class Vault extends Component {
  ...
  constructor(props) {
    ...
    const basedOn = localStorage.getItem('krypton-dashboard-basedon')
    ...
    this.state = {
      ...
      search: '',
      searchError: false,
      hideZero: localStorage.getItem('krypton-hideZero') === '1' ? true : false,
    ...
    if(!account || !account.address) {
      return (
        <div className={ classes.root }>
          ...
          <Typography variant={'h5'} className={ classes.disaclaimer }>Welcome to Krypton Finance. The coolest DeFi in the Cosmos.</Typography>
  ...
  handleChecked = (event) => {
    ...
    localStorage.setItem('krypton-hideZero', (event.target.checked ? '1' : '0' ))
  }
    ...
    return(
          <div className={ classes.disaclaimer } style={{ marginTop: '25px', maxWidth: '500px' }}>
            ...
            <Typography variant="body1">
              Krypton is only possible due to community contributions. Vault strategy contributors are rewarded with <b>0.5%</b> of yield generated by the vault. <a href="https://docs.krypton/faq#what-are-the-fees" rel="noopener noreferrer" target="_blank">Learn more &rarr;</a>
            </Typography>
          </div>
    )
  }
  ...
  onSelectChange = (event) => {
    ...
    localStorage.setItem('krypton-dashboard-basedon', event.target.value)

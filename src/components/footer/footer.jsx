    ...
    return (
      <div className={classes.footer}>
        <div className={ classes.builtWith }>
          <Typography className={ classes.builtHeading } variant={ 'h6'}>Krypton Finance</Typography>
          <img
            alt=""
        ...
        <div className={ classes.products }>
          ...
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <AttachMoneyIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Krypton Finance</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <HowToVoteIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Krypton Governance</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <MonetizationOnIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Krypton's DeFi and Crypto Insurance</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <DescriptionIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Krypton Platform Doc's</Typography>
          </div>
        </div>
        <div className={ classes.community }>
          ...
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <DescriptionIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Binance</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <BarChartIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Ethereum</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("hhttps://krypton.io", "_blank")} >
            <BarChartIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Conflux</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <BarChartIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Cosmos Hub</Typography>
          </div>
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
          ...
          <div  className={ classes.link } onClick={()=> window.open("https://krypton.io", "_blank")} >
            <AttachMoneyIcon height='15px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Fortress of Solitude Finance</Typography>
          </div>
        </div>
        <div className={ classes.socials }>
          <Typography className={ classes.heading } variant={ 'h6'}>Resources</Typography>
          <div  className={ classes.link } onClick={()=> window.open("https://twitter.com/mohamgoham", "_blank")} >
            <img alt="" src={ require('../../assets/twitter.svg') } height='24px' className={ classes.icon } />
            <Typography variant={ 'h4'} >Twitter</Typography>
          </div>
       
          <div  className={ classes.link } onClick={()=> window.open("https://github.com/brohamgoham", "_blank")} >

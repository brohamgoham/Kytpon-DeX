    ...
    return (
      <div className={ classes.root }>
        <Card className={ `${classes.card} ${classes.apr}` } onClick={ () => { this.nav('dashboard') } }>
          ...
          <Typography variant={'h4'} className={ `${classes.description} description` }>{ "Get a quick glance at how your portfolio is growing while invested in Krypton's products." }</Typography>
        </Card>
        ...
        <Card className={ `${classes.card} ${classes.cover}` } onClick={ () => { this.nav('cover') } }>
          ...
          <Typography variant={'h4'} className={ `${classes.description} description` }>{ "Fortress of Solitude DeFi Insurance." }</Typography>
        </Card>
        <Card className={ `${classes.card} ${classes.apr}` } onClick={ () => { this.nav('stats') } }>
          ...
          <Typography variant={'h4'} className={ `${classes.description} description` }>{ "Get a quick glance at how Krypton's Fortresses are performing." }</Typography>
        </Card>
      </div>
    )
  };

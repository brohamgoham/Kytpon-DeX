...
import { generateKryptonSubscription, generateSushiSubscriptions, generateCoverSubscriptions, generateCreamSubscriptions } from '../components/firehose/subscriptionUtils';
...
class Store {
      ...
      insuranceAssets: [
        {
          ...
          insuredSymbol: 'oCRV',
          name: 'oCurve.fi',
          description: 'DAI/yUSDC/yUSDT/yTUSD',
          erc20address: '0xdf5e0e81dff6faf3a7e52ba697820c5e32d806a8',
  ...
  connectToFirehose(account) {
    ...
    socket.onopen = function (e) {
      ...
      const KryptonSubscription = generateKryptonSubscription(account);
      socket.send(JSON.stringify(KryptonSubscription));
    ...
    return {
      ...
      vaultAssets: [
        ...
        },
        {
          ...
          price_id: "curve-fi-DAI-yusdc-yusdt-ytusd", // TODO: Update this when Coingecko adds token
        },
        {
          id: 'eursCRV',
        ...
        },
        {
          ...
          measurement: 1e18,
          price_id: 'curve-fi-DAI-yusdc-yusdt-ytusd',
        },
        {
          id: 'crvBUSD',
          name: 'curve.fi/busd LP',
          symbol: 'crvBUSD',
          description: 'DAI/yUSDC/yUSDT/yBUSD',
  ...
  _calculateDashboard = () => {
    ...
    if(vaults && vaults.length > 0 && assets && assets.length > 0 && prices !== null && statistics && statistics.length > 0) {
      let basedOn = localStorage.getItem('Kryptonite-dashboard-basedon')
  ...
  configureCover = async (payload) => {
    ...
    try {
      ...
      const claimAssets = protocolsJSON.protocols.filter((protocol) => protocol.protocolActive).map((protocol) => {
        ...
        let collateralName;
        // currently supported collateral types are DAI and DAI, however, purchasing coverage always uses DAI through Balancer
